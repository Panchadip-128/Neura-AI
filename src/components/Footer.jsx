    ...
    return (
        <div className="footer py-5 opacity-80 text-white" style={{ backgroundColor: '#000000' }}>
            ...
            <div className="footer-map text-left mb-4">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d31083.29798917921!2d77.59631590000001!3d13.136376300000013!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1739194998605!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"
                    width="100%"
                    height="200"
                    style={{ border: 0 }}
                    allowFullScreen=""
